...
> **현재 상태 (2026-08-07):** 2·3·4단계 완료 — **공개 배포 중**.
> 화면 https://national-assembly-3.vercel.app · API https://assembly-rag-api.onrender.com
> (무료 요금제라 15분 유휴 후 첫 요청은 50초 이상 걸릴 수 있다.
> 검색 대상은 전체가 아니라 [축소 코퍼스](#알려진-한계)다.)
