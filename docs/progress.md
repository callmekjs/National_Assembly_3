...
> **정산 (2026-08-07 기준)** — 아래 목록은 항목 28개다(예전엔 제목이 "26건"이었으나
> 목록과 맞지 않았다. 목록이 맞다). 상태: **완료 6 · 부분 1 · 미착수 21**.
> 완료: ①검증규칙 은폐 ②평가 잣대 재작성 ⑰페이지네이션 ㉔비용 단가 ㉕print ㉖설정 불일치.
> 부분: ⑬`pre_gate` — 아래 항목 설명 참조.
